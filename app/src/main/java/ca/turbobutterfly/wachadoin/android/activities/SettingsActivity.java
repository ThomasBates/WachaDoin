...
public class SettingsActivity extends AppCompatPreferenceActivity
{
    private static Preference.OnPreferenceClickListener _onPreferenceClickListener = new Preference.OnPreferenceClickListener()
    {
        ...
        public boolean onPreferenceClick(Preference preference)
        {
            ...
            {
                case "pref_notification_system_settings":
...
//            }
    ...
    public static class NotificationPreferenceFragment extends PreferenceFragment
    {
        ...
        public void onCreate(Bundle savedInstanceState)
        {
            ...
            // When their values change, their summaries are updated to reflect the new value,
            // per the Android Design guidelines.
            SetupPreferenceClick(this, "pref_notification_system_settings", !preOreo);
            SetupPreferenceSummary(this, "pref_notification_ringtone", preOreo);
            SetupPreferenceSummary(this, "pref_notification_vibrate", false);
            SetupPreferenceSummary(this, "pref_notification_delay");
            SetupPreferenceSummary(this, "pref_notification_snooze");
        }
